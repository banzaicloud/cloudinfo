...
// WithProvider adds the provider to the get services params
func (o *GetServicesParams) WithProvider(provider string) *GetServicesParams {
	o.SetProvider(provider)
	return o
}

// SetProvider adds the provider to the get services params
func (o *GetServicesParams) SetProvider(provider string) {
	o.Provider = provider
}
