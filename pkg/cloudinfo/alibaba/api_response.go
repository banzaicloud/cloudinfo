...
func (a *AlibabaInfoer) apiResponse(name, region string, instanceTypes []string) (*responses.CommonResponse, error) {
	...
	case "DescribeSpotPriceHistory":
		...
		request.QueryParams["InstanceType"] = instanceTypes[0]
	...
	default:
		return nil, errors.New("invalid API name")
	}
	return a.client.ProcessCommonRequest(request)
}
